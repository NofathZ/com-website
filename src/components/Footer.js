...
return(
    <>
        <footer class="footer-clean footer-container">
            <div class="container-md">
                <div class="row justify-content-center">
                    <div class="col-sm-4 col-md-3 item">
                        ...
                        <ul>
                            <li className="body-one">
                                ...
                                <a href="#">com.youthid@gmail.com</a>
                            </li>
                            <li className="body-one">
                                <svg style={{marginRight:"15px"}} width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div class="col-sm-4 col-md-3 item">
                        ...
                        <ul>
                            <li className="body-one"><a href="#">Structure</a></li>
                            <li className="body-one"><a href="#">About</a></li>
                            <li className="body-one"><a href="#">Open Recruitment</a></li>
                            <li className="body-one"><a href="#">FAQ</a></li>
                        </ul>
                    </div>
                    <div class="col-sm-4 col-md-3 item">
                        <h3 className="body-two">Profile</h3>
                        <ul>
                            <li className="body-one"><a href="#">COM</a></li>
                            <li className="body-one"><a href="#">Company</a></li>
                            <li className="body-one"><a href="#">Community</a></li>
                        </ul>
                    </div>
                    <div class="col-sm-4 col-md-3 item">
                        ...
                        <ul className="d-flex justify-content-start align-items-center">
                            <li>
                                <svg width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path opacity="0.1" fill-rule="evenodd" clip-rule="evenodd" d="M0 24C0 10.7452 10.7452 0 24 0C37.2548 0 48 10.7452 48 24C48 37.2548 37.2548 48 24 48C10.7452 48 0 37.2548 0 24Z" fill="white"/>
