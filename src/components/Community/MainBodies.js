  ...
  return(
    <div>
      ...
      <div className="d-flex justify-content-center main-container-community" style={{columnGap: "40px"}}>
        <div className="main-body body-two d-flex align-items-center bg-emerald-green-20 text-center"><b className="mx-auto">Boards of Directors</b></div>
        <div className="main-body body-two d-flex align-items-center bg-emerald-green-20 text-center"><b className="mx-auto">Boards of Supervisors</b></div>
      </div>
    </div>
  )
}
