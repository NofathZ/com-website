  ...
  return(
    <div className="d-flex flex-column">
      <div className={`core-card-upper text-center col-4 ${bgcolor}`}>
        <h3 className="heading-underline" style={{marginBottom: "24px"}}><b>{title}</b></h3>
        <p className="body-one">{content}</p>
      </div>
      <div className={`core-card-under text-center d-flex flex-column justify-content-center`}>
